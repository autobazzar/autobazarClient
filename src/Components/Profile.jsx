  ...
  return (
    <div dir="rtl" className='flex flex-row h-screen'>
      <div className='bg-[#2b4e47] med:rounded-bl-[4rem] med:basis-[28%] w-full flex flex-col gap-y-12 h-[92%]'>
        ...
        <div onClick={() => handleItemClick(1)} className={`cursor-pointer flex flex-row justify-start med:justify-between items-center hover:bg-[#465956] ${state.state_count === 1 && "bg-[#4C857A]" }`}>
        ...
        <div onClick={() => handleItemClick(2)} className={`cursor-pointer flex flex-row justify-start med:justify-between items-center hover:bg-[#465956] ${state.state_count === 2 && "bg-[#4C857A]" }`}>
        ...
        <div onClick={() => handleItemClick(3)} className={`cursor-pointer flex flex-row justify-start med:justify-between items-center hover:bg-[#465956] ${state.state_count === 3 && "bg-[#4C857A]" }`}>
        ...
        <div onClick={() => handleItemClick(4)} className={`cursor-pointer flex flex-row justify-start med:justify-between items-center hover:bg-[#465956] ${state.state_count === 4 && "bg-[#4C857A]" }`}>
