      ...
      <div className='basis-[72%] mt-5 pr-16'>
          ...
          <form class="w-[37%] mb-8">   
              ...
              <div class="relative min-h-0 h-full">
                  ...
                  <input type="search" id="default-search" class="block w-full h-[40px] p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="آگهیت رو جستجو کن!" required />
