import { FaPhoneAlt, FaEnvelope, FaMapMarkerAlt, FaMailBulk } from 'react-icons/fa';

export default function ContactUS() {
  return (
    <div dir="rtl" className="flex justify-center bg-gray-100 p-5 pt-10">
      {/* Contact Us Section */}
      ...
      <h2 className="text-2xl font-bold mb-4 text-black">تماس با ما</h2>
        ...
        <div className="mb-2 flex items-center">
          <FaMailBulk className="text-black ml-2" />
      ...
      {/* Address Section */}
      <div className="p-6 col-span-6 pt-10">
        <div className="mb-2 flex items-center">
          <FaMapMarkerAlt className="text-black ml-2" />
          <span className="font-bold text-black">نشانی:</span>
        </div>
